public enum HttpStatusCode: Int {
    ...
    public static let clientErrorsGroup: CountableClosedRange<Int> = (400...499)

    public static let serverErrorsGroup: CountableClosedRange<Int> = (500...599)
    ...
    public static func findOrReturnUndefined(statusCode: Int?) -> HttpStatusCode {
